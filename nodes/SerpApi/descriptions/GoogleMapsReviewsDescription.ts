...
export const googleMapsReviewsFields: INodeProperties[] = [
  {
    ...
    name: 'data_id',
    description: 'Parameter defines the Google Maps data ID. Find the data ID by using our Google Maps API.Either data_id or place_id should be set.',
    default: null,
    routing: {
      request: {
        qs: {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        name: 'topic_id',
        description: 'Parameter defines the ID of the topic you want to use for filtering reviews. You can access IDs inside our structured JSON response.',
        default: null,
        routing: {
          request: {
            qs: {
      ...
      },
      {
        ...
        name: 'num',
        description: 'Parameter defines the maximum number of results to return. It ranges from 1 to 20. It defaults to 10.Parameter cannot be used on the initial page when neither next_page_topic nor topic_id is set. It always returns 8 results.',
        default: null,
        routing: {
          request: {
            qs: {
      ...
      },
      {
        ...
        description: 'Parameter defines the next page token. It is used for retrieving the next page results.Usage of start parameter (results offset) has been deprecated by Google.',
        default: null,
        routing: {
          request: {
            qs: {
