...
export const amazonSearchFields: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { name: 'amazon.com.be', value: 'amazon.com.be' },
      ...
      { name: 'amazon.eg', value: 'amazon.eg' },
      { name: 'amazon.es', value: 'amazon.es' },
      { name: 'amazon.fr', value: 'amazon.fr' },
      { name: 'amazon.in', value: 'amazon.in' },
      { name: 'amazon.it', value: 'amazon.it' },
      { name: 'amazon.nl', value: 'amazon.nl' },
      { name: 'amazon.pl', value: 'amazon.pl' },
      { name: 'amazon.sa', value: 'amazon.sa' },
      { name: 'amazon.se', value: 'amazon.se' },
    ...
    options: [
      {
        ...
        type: 'options',
        options: [
          { name: 'amazon.ae - English - EN', value: 'amazon.ae|en_AE' },
          { name: 'amazon.ae - العربية - AR - الترجمة', value: 'amazon.ae|ar_AE' },
          { name: 'amazon.ca - English - EN', value: 'amazon.ca|en_CA' },
          { name: 'amazon.ca - français - FR', value: 'amazon.ca|fr_CA' },
          { name: 'amazon.cn - 中文 - ZH', value: 'amazon.cn|zh_CN' },
          { name: 'amazon.co.jp - English - EN - Translation', value: 'amazon.co.jp|en_US' },
          { name: 'amazon.co.jp - 中文 - ZH - 翻译', value: 'amazon.co.jp|zh_CN' },
          { name: 'amazon.co.jp - 日本語 - JA', value: 'amazon.co.jp|ja_JP' },
          { name: 'amazon.co.uk - English - EN', value: 'amazon.co.uk|en_GB' },
          { name: 'amazon.com - English - EN', value: 'amazon.com|en_US' },
          { name: 'amazon.com - español - ES - Traducción', value: 'amazon.com|es_US' },
          { name: 'amazon.com.au - English - EN', value: 'amazon.com.au|en_AU' },
          { name: 'amazon.com.be - English - EN - Translation', value: 'amazon.com.be|en_GB' },
          { name: 'amazon.com.be - français - FR', value: 'amazon.com.be|fr_BE' },
          { name: 'amazon.com.be - Nederlands - NL', value: 'amazon.com.be|nl_BE' },
          { name: 'amazon.com.br - português - PT', value: 'amazon.com.br|pt_BR' },
          { name: 'amazon.com.mx - português - PT - Tradução', value: 'amazon.com.mx|pt_MX' },
          { name: 'amazon.com.tr - Türkçe - TR', value: 'amazon.com.tr|tr_TR' },
          { name: 'amazon.de - čeština - CS - Překlad', value: 'amazon.de|cs_CZ' },
          { name: 'amazon.de - dansk - DA - Oversættelse', value: 'amazon.de|da_DK' },
          { name: 'amazon.de - Deutsch - DE', value: 'amazon.de|de_DE' },
          { name: 'amazon.de - English - EN - Translation', value: 'amazon.de|en_GB' },
          { name: 'amazon.de - Nederlands - NL - Vertaling', value: 'amazon.de|nl_NL' },
          { name: 'amazon.de - polski - PL - Tłumaczenie', value: 'amazon.de|pl_PL' },
          { name: 'amazon.de - Türkçe - TR - Çeviri', value: 'amazon.de|tr_TR' },
          { name: 'amazon.eg - English - EN - Translation', value: 'amazon.eg|en_AE' },
          { name: 'amazon.eg - العربية - AR', value: 'amazon.eg|ar_AE' },
          { name: 'amazon.es - English - EN - Translation', value: 'amazon.es|en_GB' },
          { name: 'amazon.es - español - ES', value: 'amazon.es|es_ES' },
          { name: 'amazon.es - português - PT - Tradução', value: 'amazon.es|pt_PT' },
          { name: 'amazon.fr - English - EN - Translation', value: 'amazon.fr|en_GB' },
          { name: 'amazon.fr - français - FR', value: 'amazon.fr|fr_FR' },
          { name: 'amazon.in - English - EN', value: 'amazon.in|en_IN' },
          { name: 'amazon.in - मराठी - MR - भाषांतर', value: 'amazon.in|mr_IN' },
          { name: 'amazon.in - हिन्दी - HI - अनुवाद', value: 'amazon.in|hi_IN' },
          { name: 'amazon.in - বাংলা - BN - অনুবাদ', value: 'amazon.in|bn_IN' },
          { name: 'amazon.in - தமிழ் - TA - மொழிபெயர்ப்பு', value: 'amazon.in|ta_IN' },
          { name: 'amazon.in - తెలుగు - TE - అనువాదం', value: 'amazon.in|te_IN' },
          { name: 'amazon.in - ಕನ್ನಡ - KN - ಭಾಷಾಂತರ', value: 'amazon.in|kn_IN' },
          { name: 'amazon.in - മലയാളം - ML - വിവർത്തനം', value: 'amazon.in|ml_IN' },
          { name: 'amazon.it - English - EN - Translation', value: 'amazon.it|en_GB' },
          { name: 'amazon.it - italiano - IT', value: 'amazon.it|it_IT' },
          { name: 'amazon.nl - English - EN - Translation', value: 'amazon.nl|en_GB' },
          { name: 'amazon.nl - Nederlands - NL', value: 'amazon.nl|nl_NL' },
          { name: 'amazon.pl - polski - PL', value: 'amazon.pl|pl_PL' },
          { name: 'amazon.sa - English - EN - Translation', value: 'amazon.sa|en_AE' },
          { name: 'amazon.sa - العربية - AR', value: 'amazon.sa|ar_AE' },
          { name: 'amazon.se - English - EN - Translation', value: 'amazon.se|en_GB' },
          { name: 'amazon.se - svenska - SV', value: 'amazon.se|sv_SE' },
          { name: 'amazon.sg - English - EN', value: 'amazon.sg|en_SG' }
        ]
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          { name: 'Haiti', value: 'HT' },
          { name: 'Heard Island and the McDonald Islands', value: 'HM' },
