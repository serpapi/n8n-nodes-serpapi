  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        name: 'df',
        description: 'Parameter defines results filtered by date.It can be set to:d: Past day,w: Past week,m: Past month,y: Past year,or you can pass a custom date following the next format: from_date + .. + to_date (e.g. 2021-06-15..2021-06-16).',
        default: null,
        routing: {
          request: {
            qs: {
