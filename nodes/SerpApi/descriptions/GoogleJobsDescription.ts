  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Parameter defines the next page token. It is used for retrieving the next page of results. Up to 10 results are returned per page.The next page token can be found in the SerpApi JSON response: serpapi_pagination -&gt; next_page_tokenUsage of start parameter (results offset) has been deprecated by Google.",
        "default": "",
        "routing": {
          "request": {
            "qs": {
      ...
      },
      {
        ...
        "description": "This parameter has been deprecated by Google.Parameter defines additional query conditions. Top of a job search page contains elements called chips, its values are extracted in order to be passed to chips parameter. E.g. city:Owg_06VPwoli_nfhBo8LyA== will return results for New York.",
        "default": "",
        "routing": {
          "request": {
            "qs": {
      ...
      },
      {
        ...
        "description": "Parameter will filter the results by work from home.",
        "default": false,
        "routing": {
          "request": {
            "qs": {
