...
export const googleMapsFields: INodeProperties[] = [
  ...
  },
  {
    ...
    "description": "Parameter defines the type of search you want to make. It can be set to:search - returns a list of results for the set q parameter,place - returns results for a specific place when data parameter is setParameter is not required when using place_id.",
    "default": "search",
    "routing": {
      "request": {
        "qs": {
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Parameter can be used to filter the search results. You can visit Google Maps website, set filters you want and simply copy the data value from their URL to SerpApi URL.\n            One of the uses of the parameter is to search for a specific place; therefore, it is required if the type is set to place.\n            Alternatively, place_id can be used.\n            To use the data parameter to search for a specific place, it needs to be constructed in the following sequence:!4m5!3m4!1s + data_id + !8m2!3d + latitude + !4d + longitude\n            This will form a string that looks like this: !4m5!3m4!1s0x89c259b7abdd4769:0xc385876db174521a!8m2!3d40.750231!4d-74.004019.\n            You can find the data_id using our Google Maps API.",
        "default": "",
        "routing": {
          "request": {
            "qs": {
